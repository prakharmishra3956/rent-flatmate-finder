...
export default function TenantSidebar() {
  ...
  const navItems = [
    ...
    { name: "My Applications", href: "/tenant/requests", icon: Heart },
  ...
  return (
    <aside className="w-64 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 flex flex-col h-screen sticky top-0 shrink-0">
      ...
      <div className="h-16 flex items-center px-6 border-b border-zinc-200 dark:border-zinc-800">
        <Link href="/tenant/dashboard" className="flex items-center gap-2 font-bold text-lg text-indigo-600 dark:text-indigo-400">
